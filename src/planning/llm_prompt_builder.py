...
def render_llm_synthesis_prompt_text(
    ...
    return "\n".join(
        [
            ...
            "- The second direction must be scope_level medium, build_type resume_mvp, estimated_time 3-5 days.",
            "- The third direction must be scope_level hard, build_type flagship_extension, estimated_time 1-2 weeks.",
